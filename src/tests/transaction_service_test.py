...
class TestTransactionService(unittest.TestCase):
    ...
    def test_add_income_saves_the_amount_in_right_format(self):
        self.transaction_service.create("12.04.2022", "income", "253.69", "Tulonsiirrot", "Opintotuki", 1)
    ...
    def test_add_expense_saves_the_amount_in_right_format(self):
        self.transaction_service.create("12.04.2022", "expense", "648.23", "Asuminen", "Vuokra", 1)
    ...
    def test_add_transaction_with_too_big_amount(self):
        self.assertRaises(TooBigNumberError, self.transaction_service.create, "12.04.2022", "expense", "9223372036854775808", "Asuminen", "Vuokra")
    ...
    def test_get_transaction(self):
        self.transaction_service.create("03.05.2022", "expense", "32.87", "Ruoka ja päivittäistavarat", user_id=1)
        transaction = self.transaction_service.get_one(1)
