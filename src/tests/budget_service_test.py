...
class TestBudgetService(unittest.TestCase):
    ...
    def test_add_income_saves_the_amount_in_right_format(self):
        self.budget_service.add_transaction("2022-04-12", "income", "253.69", "Tulonsiirrot", "Opintotuki")
    ...
    def test_add_expense_saves_the_amount_in_right_format(self):
        self.budget_service.add_transaction("2022-04-12", "expense", "648.23", "Asuminen", "Vuokra")
        transaction = self.budget_service.find_transactions()[0]
        self.assertEqual(transaction[2], -64823)

    def test_add_transaction_with_too_big_amount(self):
        self.assertRaises(TooBigNumberError, self.budget_service.add_transaction, "2022-04-12", "expense", "9223372036854775808", "Asuminen", "Vuokra")
        
    def test_add_transaction_with_wrong_type_of_amount(self):
        self.assertRaises(AmountInWrongFormatError, self.budget_service.add_transaction, "2022-04-12", "expense", "648,23 €", "Asuminen", "Vuokra")

    def test_get_transaction(self):
        self.budget_service.add_transaction("2022-05-03", "expense", "32.87", "Ruoka ja päivittäistavarat")
        transaction = self.budget_service.get_transaction(1)
        self.assertEqual(transaction, ("2022-05-03", -3287, "Ruoka ja päivittäistavarat", None))

    def test_update_transaction(self):
        self.budget_service.add_transaction("2022-05-03", "expense", "32.87", "Ruoka ja päivittäistavarat")
        self.budget_service.update_transaction(1, "2022-05-03", "expense", "32.85", "Ruoka ja päivittäistavarat")
        transaction = self.budget_service.get_transaction(1)
        self.assertEqual(transaction, ("2022-05-03", -3285, "Ruoka ja päivittäistavarat", None))

    def test_delete_transaction(self):
        self.budget_service.add_transaction("2022-05-03", "expense", "32.87", "Ruoka ja päivittäistavarat")
        self.budget_service.delete_transaction(1)
